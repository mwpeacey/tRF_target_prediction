...
open_reading_frames = read.table('import/transcriptome_assembly/mouse_embryo_assembled_transcripts_ORFs.bed') %>%
...
blast_output = read.csv(file = 'import/transcriptome_assembly/mouse_embryo_assembled_transcripts_ORFs_blast.csv', header = F) %>%
